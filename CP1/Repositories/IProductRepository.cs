...
public interface IProductRepository {
    ...
    // Obtener los productos pero con el IVA añadido al precio. El IVA será un número
    // entero que reciba por parámetro (por defecto valdrá 21) y será entre 1 y 100
    // (validar que no exceda estos rangos, si excede los rangos dejamos el valor por
    ...
    * Calcular **beneficio neto** teniendo en cuenta precios y cantidades menos coste
    ...
    -- -- Check update and save methods, specifically the (exists int,product) one of the two might need to go
        -- remove unnecessary gets of full product
